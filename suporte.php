...
<div class="container">
  ...
  color: black; font-size: 60px;">Suporte</h1>
  <div class="row">
  <div class="col">
    <div id="carouselExampleControls" class="carousel slide"  data-bs-ride="carousel" style="padding-bottom: 20%; padding-top: 13%;   padding-left: 14%;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img  src="img/suporte.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/suporte2.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/suporte3.jpg" width="100%" alt="...">  
    </div>
  </div>
    </div>
    </div>
    <div class="col">
      <p style="font-size: 18px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px; padding-top: 50px;">
        ...
        O suporte ao cliente é um aspecto crítico de qualquer
      negócio, independentemente do tamanho ou setor. É uma
      das maneiras mais importantes de manter os clientes
      satisfeitos e garantir que eles tenham uma boa experiência
      com o produto ou serviço que estão utilizando. O suporte
      ao cliente envolve o fornecimento de assistência, informações
      e soluções para as dúvidas, problemas e reclamações dos
      clientes.
        
      </p>
      <p style="font-size: 18px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
        O suporte ao cliente deve ser personalizado. Cada cliente é
        único, e as empresas devem reconhecer e tratar cada um
        de maneira individual. Os representantes de suporte ao
        cliente devem estar cientes das necessidades e necessidades
        do cliente e adaptados à sua abordagem de acordo.
      </p>
      <div>
