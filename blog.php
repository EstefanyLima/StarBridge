...
<section class="container">
  ...
  color: black; font-size: 60px;">Blog</h1>
  <div class="row">
    <div class="col">
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/blog.jpg" width="100%" alt="...">  
    </div>
    ...
    <div class="col">
      ...
      Um blog é um site ou uma seção de um site que
      apresenta postagens de conteúdo regular,
      organizadas em ordem cronológica inversa. Os
      blogs são usados para compartilhar informações,
      opiniões e ideias com uma audiência online.
      Eles também são usados como ferramentas de
      marketing digital para atrair tráfego para um site e
      aumentar o engajamento do público com uma
      marca ou empresa.
      </p>
      <div>
