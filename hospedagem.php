...
<div class="container">
    ...
    color: black; font-size: 60px;">Hospedagem</h1>
    <div class="row">
    <div class="col">
    <div id="carouselExampleControls" class="carousel slide"  data-bs-ride="carousel" style="padding-bottom: 20%; padding-top: 11%;   padding-left: 14%;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img  src="img/web.png" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/web2.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/web3.jpg" width="100%" alt="...">  
    </div>
  </div>
    </div>
    </div>
      <div class="col">
        <p style="font-size: 17px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px; padding-top: 40px;">
        
          A hospedagem de um site é um dos aspectos mais
  importantes quando se trata de criar uma presença
  online para sua empresa ou projeto. É o serviço que permite
  que o seu site seja acessado na internet por pessoas de todo
  o mundo. Sem hospedagem, o seu site não pode ser visto
  por ninguém.
          
        </p>
        <p style="font-size: 17px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
          Uma das principais coisas a se considerar ao escolher uma
          hospedagem é a confiabilidade do serviço. Você quer ter
          certeza de que o seu site estará sempre online e disponível
          para os visitantes. A maioria dos provedores de
          hospedagem garante uma alta disponibilidade, o que
          significa que seu site estará disponível 99,9% do tempo.
          Certifique-se de verificar as estimativas dos usuários e
          pesquisar sobre a opinião da empresa antes de escolher
          um provedor.
        </p>
        <div>
