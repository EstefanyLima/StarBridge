...
<div class="container">
  ...
  color: black; font-size: 60px;">Segurança</h1>
  <div class="row">
  <div class="col">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img  src="img/segu.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/segu2.png" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/segu3.png" width="100%" alt="...">  
    </div>
  </div>
    </div>
    </div>
    <div class="col">
      <p style="font-size: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px; padding-top: 60px;">
      
        A segurança da informação é um tema cada vez mais
      importante no mundo moderno. Com a crescente
      dependência da tecnologia e da internet, a proteção dos
      dados pessoais e empresariais se tornou uma necessidade
      vital para evitar fraudes, roubos e ataques cibernéticos.
      ...
      <p style="font-size: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
        ...
        a proteção de dados, a privacidade, a integridade dos
        sistemas, a confidencialidade das informações e a disponibilidade dos recursos. Ela é fundamental para
        garantir a continuidade das operações das empresas, a confiança dos clientes e a integridade das informações.
      </p>
      <div>
