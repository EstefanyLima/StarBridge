...
color: black; font-size: 60px;">Design</h1>

  <div class="row">
    <div class="col">
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style=" padding-top: 13%; ">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/desing.jpg" width="100%"style="padding-left: 20px; padding-top: 50px;" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/desing2.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/design 3.jpg" width="100%" alt="...">  
    </div>
  </div>
    </div>
    </div>
    <div class="col">
      <p style="font-size: 18px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding-left: 20px; padding-top: 50px;">
      
        O design de um site é um elemento fundamental para o 
        sucesso de um projeto na internet. Ele envolve a escolha 
       das cores, tipografia, layout, imagens e gráficos, 
        responsividade, acessibilidade e outros aspectos visuais 
        que compõem a interface do site. O design deve ser 
       pensado para atender às necessidades dos usuários e 
      fornecer uma experiência agradável, fácil e intuitiva.
        
      </p>
      <p style="font-size: 18px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding-left: 20px;">
        Em resumo, o design de um site é um aspecto crucial para 
    o sucesso de um projeto online. Ele deve ser pensado de 
  forma estratégica e cuidadosa, levando em consideração as 
    necessidades dos usuários e as melhores práticas de design 
    na web. Um design bem executado pode aumentar a 
    eficiência e a usabilidade do site, gerar engajamento dos 
    usuários e facilitar a navegação, enquanto um design ruim 
