...
<div class="container">
  ...
  color: black; font-size: 60px;">Site</h1>
  <div class="row">
    <div class="col">
      <img width="570px" src="img/site.jpg" style="padding-right: 20px; margin-top: 70px;">
    </div>
    <div class="col">
      <p style="font-size: 16px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px; padding-top: 50px;">
      
        Um site na internet pode ser uma ferramenta
        poderosa para qualquer pessoa que queira alcançar
        um público mais amplo e estabelecer uma presença online.
        Há várias razões pelas quais criar um site pode ser vantajoso,
        e é importante considerar todas elas antes de tomar uma decisão.
        
      </p>
      <p style="font-size: 16px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
        Outro motivo para criar um site é aumentar a credibilidade
  de sua marca ou negócio. Hoje em dia, muitos clientes
  em potencial pesquisam sobre uma empresa na internet
  antes de fazer uma compra ou contratar um serviço. Se eles encontrarem um site bem projetado e fácil de navegar,
  com informações claras e úteis, eles serão mais propensos
  a confiar em sua empresa e escolhê-la em vez de um concorrente.
      </p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col">
      <p style="font-size: 15px;font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
      
        <p>
          <br><br>
          <h2 class="text-center mt-4 text-dark">Tipos de sites que fazemos:</h2>
          <br>
          <p>1. Site institucional;</p>
          <p>2. Site dinâmico;</p>
         <p> 3. Loja virtual;</p>
          <p>4. Site one-page;</p>
         <p> 5. Hostsite;</p>
    ...
    <div class="col">
      <img width="570px" src="img/pro2.jpg" style="padding-right: 20px; margin-top: 100px;">
    </div>
  </div>
...
<div class="row">
  <div class="col">
    <img width="570px"src="img/pro.jpg" style="padding-right: 20px; margin-top: 100px;">
  </div>
  <div class="col">
    <p style="font-size: 15px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px;">
    
      <p> 
        <h3 class="text-center mt-4 text-dark">Nós utilizaremos na programação do seu site:</h3>
        <p>CSS;</p>
        <p>HTML;</p>
        <p>JavaScript;</p>
        <p>PHP;</p>
        <p>SQL ou Banco de Dados;</p>
        <p>Phyton;</p>
        <p>jQuery e Bootstrap.</p>
        <br><br><br><br>
