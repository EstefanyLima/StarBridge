...
<div class="container">
  ...
  color: black; font-size: 60px;">Edição de imagem</h1>
  <div class="row">
    <div class="col">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img  src="img/edicao.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/edicao2.jpg" width="100%" alt="...">  
    </div>
    <div class="carousel-item">
      <img src="img/edicao3.jpg" width="100%" alt="...">  
    </div>
  </div>
    </div>
    </div>
    <div class="col">
      <p style="font-size: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding-left: 20px; padding-top: 50px;">
      
        A edição de imagem é uma das atividades mais importantes
        no universo da fotografia e do design gráfico. É por meio
        da edição que se pode ajustar cores, remover elementos
        indesejados, corrigir imperfeições, adicionar elementos e
        criar efeitos especiais, entre outras possibilidades.   
        
      </p>
      <p style="font-size: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding-left: 20px;">
        A edição de imagem pode ser utilizada em diversos
        contextos, como na produção de fotografias para
        redes sociais, em campanhas publicitárias, na criação de
         materiais gráficos para empresas e em projetos pessoais,
        como álbuns de fotografias e cartões de aniversário.
      </p>
      <div>
    <a href="orcamento.php" style="color: black;" class="botao01">Ver orçamento</a><br>
   </div>
    </div>
  </div>
  </div>
